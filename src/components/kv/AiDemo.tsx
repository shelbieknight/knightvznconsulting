      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-[80px] items-center">
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={s.step} className="flex items-center gap-5 group">
                  <div className="w-12 h-12 border-2 border-pop/30 flex items-center justify-center font-mono text-sm text-pop font-bold group-hover:text-accent-foreground transition-all relative overflow-hidden">
                    <div className="absolute inset-0 scale-0 group-hover:scale-100 transition-transform duration-300" style={{ background: "var(--gradient-primary)" }} />
        ...
        <AnimatedSection delay={0.15}>
          <div className="overflow-hidden border border-primary-foreground/10 shadow-[0_40px_100px_-20px_hsl(var(--pop)/0.15)]">
            ...
            <div className="bg-[#0a0c14] p-7 pb-8 font-mono text-[13px] leading-[2.2]">
              <div className="text-primary-foreground/50">
                <span className="text-pop font-bold">$ </span>
                <span className="text-electric font-medium">knightvzn audit --full-stack</span>
              </div>
